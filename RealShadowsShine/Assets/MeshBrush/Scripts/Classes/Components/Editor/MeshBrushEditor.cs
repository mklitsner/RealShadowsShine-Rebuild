    ...
    public class MeshBrushEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.BeginHorizontal();
            {
                ...
                EditorGUILayout.LabelField(new GUIContent("Stats", "Displays a statistics label at the top of the MeshBrush inspector.\n\nThe displayed numbers refer to the total amount of meshes and triangles that have been painted with this MeshBrush instance."), GUILayout.Width(32f), GUILayout.ExpandWidth(false));
            }
            EditorGUILayout.EndHorizontal();
